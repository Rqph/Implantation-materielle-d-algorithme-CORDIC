...
def gen_graphP1():
    ...
    for i in N :
        ...
        plt.figure()
        plt.plot(x,'r*-')
        plt.suptitle(f'Erreur Cos pour n={i} itérations [CODAGE FLOTTANT]')
        ...
        plt.figure()
        plt.plot(y,'g*-')
        plt.suptitle(f'Erreur Sin pour n={i} itérations [CODAGE FLOTTANT]')
        plt.title("Phi allant de 0 à 90°")
        plt.yscale('log')
    ...
    plt.suptitle(f'Erreur Cos en fonction de n [CODAGE FLOTTANT]')
    plt.yscale('log')
    ...
    plt.title(f'Echelle Log')
    plt.suptitle(f'Erreur Sin en fonction de n [CODAGE FLOTTANT]')
    plt.yscale('log')
